...
def main():
    ...
    print("Ascending until marker is detected or timeout.")
    ...
    try:
        while True:
            ...
            if ids is not None and len(ids) > 0:
                ...
                print("Marker detected. Landing now.")
                break
            else:
                cv2.putText(frame, "Searching for marker...", (30, 50),
            ...
            if time.time() - detection_start_time > NO_MARKER_TIMEOUT:
                print("Timeout. No marker detected.")
                break
        ...
        time.sleep(1)
        cap.release()
        recorder.release()      # release the file when done
